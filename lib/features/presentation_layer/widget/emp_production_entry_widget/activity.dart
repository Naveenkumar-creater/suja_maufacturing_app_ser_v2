...
// class EmpProductionPage extends StatefulWidget {
//   final int? empid;
//   final int? processid;
...
//   @override
//   State<EmpProductionPage> createState() => _EmpProductionEntryPageState();
// }

// class _EmpProductionEntryPageState extends State<EmpProductionPage> {
...
//         ipdCardNo:int.tryParse(cardNoController.text) ?? empproduction.ipdcardno,
...
//         ipdAssetId: assetid ?? int.tryParse(assetCotroller.text),
//         //ipdcardno: empproduction.first.ipdcardno,
//         ipdItemId: itemid ?? int.tryParse(productNameController.text),
//         ipdMpmId: processid,
...
//           hint: Text("Select"), // Default value is 'Select'
//           underline: Container(
...
//             setState(() {
//               activityDropdown = newValue; // Update the selected value
//             });
//             if (newValue != null) {
//               activityid = activity!
//                   .firstWhere((product) => product.paActivityName == newValue,)
//                   ?.paId;
//               if (activityid != null) {
//                 final itemid = Provider.of<CardNoProvider>(context, listen: false)
//                     .user
...
//             } else {
//               setState(() {
//                 activityDropdown = null; // Reset activityDropdown to null if no value is selected
//               });
//               productid = null;
//             }
//           },
